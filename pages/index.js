      ...
      <Box pb="48px">
        <Center mb="24px">
          <VStack>
            <Text
              ...
              as="h1"
            >
              {language === 'en' ? "Escape from Tarkov Ammo and Armor Charts" : "Escape from Tarkov | Tablas de Munición y Blindaje"}
            </Text>
            <Text color="tarkovYellow.100" fontSize="sm">
              {language === 'en' ? "Updated for" : "Aggiornado por"} v0.12.12.30
            </Text>
            <HStack>
              <Center>
                <Text
        ...
        <Center>
          <Flex pt="24px" px="8px" w={["100%", "75%"]}>
            <Legenda isDesktop={!isMobile} language={language} />
          </Flex>
        </Center>

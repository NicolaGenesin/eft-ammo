...
const Legenda = ({ isDesktop }) => {
  return (
    <Table variant="unstyled" size="sm" bg="vulcan.900" color="white">
      ...
      <Tbody>
        ...
        <Tr>
          ...
          {isDesktop && (
            <Td>
              Typically doesn't penetrate at all for a large number of hits, or
              starts with a very low chance and barely increases
            </Td>
          )}
        </Tr>
        <Tr>
          ...
          {isDesktop && (
            <Td>
              Has a very low or no penetration chance intially and very slowly
              gains chance
            </Td>
          )}
        </Tr>
        <Tr>
          ...
          {isDesktop && (
            <Td>
              Has a low penetration chance intially and slowly gains chance, or
              quickly damages armor until it penetrates
            </Td>
          )}
        </Tr>
        <Tr>
        ...
        <Tr>
          ...
          {isDesktop && (
            <Td>
              Penetrates a large percent of the time intially, often quickly
              going to {">"}90%
            </Td>
          )}
        </Tr>
